 ...
 * @author Msi
 */
public class gestion_symptomes extends javax.swing.JFrame {
MyConnection conn3=new MyConnection();
    Statement stm3;
    ResultSet Rs3;
    DefaultTableModel model3=new DefaultTableModel();
    /**
     * Creates new form gestion_symptomes
     */
    public gestion_symptomes() {
        initComponents();
        this.setLocationRelativeTo(null);
        
        
        model3.addColumn("id");
model3.addColumn("symptome");


try {
stm3=conn3.getConnection().createStatement();
ResultSet Rs=stm3.executeQuery("SELECT id, symptome FROM symptomes");
while(Rs.next()){
model3.addRow(new Object[]{Rs.getString("id"),Rs.getString("symptome")});
...
tble.setModel(model3);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Gestion des symptomes");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String requete="insert into symptomes(id,symptome)VALUES('"+id+"','"+nom+"',"
        + ")";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            stm3.executeUpdate("UPDATE symptomes SET symptome='"+txtno.getText()+
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            {
                Rs3 = stm3.executeQuery("SELECT id, symptome FROM symptomes WHERE id = '"+txtre.getText()+"'");
            }while (Rs3.next()){

                Object [] prof ={Rs3.getInt(1),Rs3.getString(2)};
                model3.addRow(prof);
            } if (model3.getRowCount () == 0){JOptionPane.showMessageDialog(null,"il y a aucun symptomes");
...
private void deplace(int i){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            if(JOptionPane.showConfirmDialog(null,"attention vous allez supprimer un symptome,est ce que tu est sure?"
                ,"supprimer symptome",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION)

        if(txtid.getText().length() != 0){
            stm3.executeUpdate("Delete From symptomes where id = "+txtid.getText()); afficher();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gestion_symptomes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gestion_symptomes().setVisible(true);
            }
        });
    }
