...
ResultSet Rs=stm2.executeQuery("SELECT * FROM reservation");
while(Rs.next()){
...
tble.setModel(model1);
    ...
    private void initComponents() {
        ...
        tble.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "prenom", "nom", "date", "temp", "status", "prix"
            }
        ));
        ...
        txtville1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtville1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtville1ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtville1, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtnot, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtnot1, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(txtnot2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
...
ResultSet Rs=stm2.executeQuery("SELECT * FROM reservation ;");
while(Rs.next()){
model1.addRow(new Object[]{Rs.getString("id"),Rs.getString("prenom"),Rs.getString("nom"),
    Rs.getString("date"),Rs.getString("temp"),Rs.getString("status"),Rs.getString("prix"),Rs.getString("code")});
...
private void deplace(int i){
        try{
            ...
            txtpr.setText(model1.getValueAt(i,1).toString());
            txtno.setText(model1.getValueAt(i,2).toString());
            txtville.setText(model1.getValueAt(i,3).toString());
            txtville1.setText(model1.getValueAt(i,4).toString());
            txtnot.setText(model1.getValueAt(i,5).toString());
            txtnot1.setText(model1.getValueAt(i,6).toString());
            txtnot2.setText(model1.getValueAt(i,7).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String date=txtville.getText();
        String temp=txtville1.getText();
        String status=txtnot.getText();
        String prix=txtnot1.getText();
        String code=txtnot2.getText();
        String requete="insert into reservation(id,prenom,nom,date,temp,status,prix,code)VALUES('"+id+"','"+prenom+"','"+nom+"',"
        + "'"+date+"'"  + "'"+temp+"'"  + "'"+status+"'"  + "'"+prix+"'"  + ",'"+code+"')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            stm2.executeUpdate("UPDATE reservation SET prenom='"+txtpr.getText()+"',nom='"+txtno.getText()+
                "',date='"+txtville.getText()+"',temp='"+txtville1.getText()+"',status='"+txtnot.getText()+"',prix='"+txtnot1.getText()+"',code='"+txtnot2.getText()+
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            {
                Rs2 = stm2.executeQuery("Select * From reservation WHERE id = '"+txtre.getText()+"'");
            }while (Rs2.next()){

                Object [] prof ={Rs2.getInt(1),Rs2.getString(2),Rs2.getString(3),Rs2.getString(4),Rs2.getString(5),Rs2.getString(6),Rs2.getString(7),Rs2.getString(8)};
                model1.addRow(prof);
            } if (model1.getRowCount () == 0){JOptionPane.showMessageDialog(null,"il y a aucun rendez-vous");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            if(JOptionPane.showConfirmDialog(null,"attention vous allez supprimer un rendez-vous,est ce que tu est sure?"
                ,"supprimer rendez-vous",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION)

        if(txtid.getText().length() != 0){
            stm2.executeUpdate("Delete From reservation where id = "+txtid.getText()); afficher();
    ...
    private void txtville1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtville1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtville1ActionPerformed
